...
class StudentInfo :
 ...
 public:
  ...
  inline StudentInfo* New() const final {
    return CreateMaybeMessage<StudentInfo>(nullptr);
  }

  StudentInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 StudentInfo::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 StudentInfo::id() const {
  // @@protoc_insertion_point(field_get:contacts.StudentInfo.id)
  return _internal_id();
}
inline void StudentInfo::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  id_ = value;
}
inline void StudentInfo::set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void StudentInfo::set_str(const std::string& value) {
...
inline void StudentInfo::set_str(std::string&& value) {
  
  str_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:contacts.StudentInfo.str)
}
inline void StudentInfo::set_str(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  str_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:contacts.StudentInfo.str)
}
inline void StudentInfo::set_str(const char* value, size_t size) {
  
  str_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:contacts.StudentInfo.str)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 StudentInfo::_internal_opt() const {
  return opt_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 StudentInfo::opt() const {
  // @@protoc_insertion_point(field_get:contacts.StudentInfo.opt)
  return _internal_opt();
}
inline void StudentInfo::_internal_set_opt(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  opt_ = value;
}
inline void StudentInfo::set_opt(::PROTOBUF_NAMESPACE_ID::int32 value) {
